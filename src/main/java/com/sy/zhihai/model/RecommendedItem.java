 ...
 */
public class RecommendedItem implements Comparable<RecommendedItem> {
    //推荐的项目id
    String itemID;
    //对该项目的预测评分
    ...
    public int compareTo(RecommendedItem o) {
        RecommendedItem item = o;
        if (item.predictRating > this.predictRating) {
            return 1;
        } else if (item.predictRating < this.predictRating) {
            return -1;
        } else {
            return 0;
        }
